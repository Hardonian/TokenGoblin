...
PACKAGES = [
    ...
    },
    {
        ...
        'price': 29,
        'period': '/ month',
        'limits': ['5 tenants', '100,000 events/mo', 'Forecasting', 'Routing recommendations'],
    ...
    },
    {
        ...
        'price': 99,
        'period': '/ month',
        'limits': ['Unlimited tenants', 'Unlimited events', 'Audit trail + RBAC', 'SLA'],
...
def quote_text(pkg: Package, currency: str = 'USD') -> str:
    price_display = 'Free' if pkg.price == 0 else f'{currency} {pkg.price}{pkg.period}'
